...
with torch.autograd.no_grad():
    ...
    run_eval(image_dir= '/data/coco/images/val2017', anno_file = '/data/coco/annotations/person_keypoints_val2017.json', vis_dir = '/data/coco/images/vis_val2017', model=model, preprocess='rtpose')
